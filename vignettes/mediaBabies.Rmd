...
# Make sure package is installed first or else library won't work 
library("mediaBabies")
```
...
media_influence_object <- influences(media_influenced_df)
baby_pc_object <- baby_pc(babies_pc)
babies_count_object <- baby_count(babies_df)
```

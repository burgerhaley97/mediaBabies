...
head(female_babies) ## use Adaline
...
name_influenced <- media_influenced_df[media_influenced_df$name == "Adaline"]
```
...
babies_Adaline <- baby_df[["Adaline"]]
baby_count_obj <- baby_count("Adaline", as.numeric(1973), babies_name_df)
```

Plot the custom objects from above to visualize the result 
```{r}
# plot and visualize the results 
plot(media_influence, baby_count_obj)
